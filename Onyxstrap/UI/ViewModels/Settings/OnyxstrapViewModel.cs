...
{
    public class OnyxstrapViewModel : NotifyPropertyChangedViewModel
    {
        ...
        private void ExportData()
        {
            ...
            { 
                FileName = $"Onyxstrap-export-{timestamp}.zip",
        ...
        {
            const string LOG_IDENT = "OnyxstrapViewModel::AddFilesToZipStream";
