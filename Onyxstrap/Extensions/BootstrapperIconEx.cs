...
namespace Onyxstrap.Extensions
{
    static class BootstrapperIconEx
    {
        ...
        {
            BootstrapperIcon.IconOnyxstrap,
            ...
            BootstrapperIcon.IconOnyxstrapClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconOnyxstrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconOnyxstrap => Properties.Resources.IconOnyxstrap,
                ...
                BootstrapperIcon.IconOnyxstrapClassic => Properties.Resources.IconOnyxstrapClassic,
                _ => Properties.Resources.IconOnyxstrap
            };
        }
    }
}
