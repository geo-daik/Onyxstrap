...
namespace Onyxstrap
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "Onyxstrap-QA";
#else
        ...
        public static string WebUrl
        {
            get {
                ...
                string url = ConstructOnyxstrapWebUrl();
        ...
        public static string ConstructOnyxstrapWebUrl()
        {
            ...
            if (Settings.Prop.WebEnvironment == WebEnvironment.Production || !Settings.Prop.DeveloperMode)
                return "services.onyxstrap.dev";

            string? sub = Settings.Prop.WebEnvironment.GetDescription();
            return $"services-{sub}.onyxstrap.dev";
        }
